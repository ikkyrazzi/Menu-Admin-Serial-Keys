    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('tampilan.books.update', $books->id) }}">
                            @method('put') @csrf
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <label>Kode Buku</label>
                                        <input type="text" class="form-control @error('kode_buku') is-invalid @enderror" name="kode_buku" id="kode_buku" value="{{ $books->kode_buku }}" required autofocus />
                                        @error('kode_buku')
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('judul_buku') is-invalid @enderror" name="judul_buku" id="judul_buku" value="{{ $books->judul_buku }}" required />
                                        @error('judul_buku')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('kategori') is-invalid @enderror" id="kategori" name="kategori">
                                            <option value="{{ $books->kategori }}">{{ ucwords(strtolower($books->kategori)) }}</option>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('penerbit') is-invalid @enderror" id="penerbit" name="penerbit" required>
                                            <option value="{{ $books->penerbit }}">{{ ucwords(strtolower($books->penerbit)) }}</option>
                                            <option value="">Pilih</option>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="keterangan" id="keterangan" class="form-control" cols="30" rows="10">{{ $books->keterangan }}</textarea>
                                        @error('keterangan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
